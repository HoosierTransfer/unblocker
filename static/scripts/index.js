...
if (urlParams.get("url") != null) {
  ...
  window.navigator.serviceWorker.register('./sw.js', {
    ...
    if (!isUrl(url)) url = 'https://duckduckgo.com/?q=test' + url;
...
<p><iframe src="./menu.html" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:0px;left:0px;right:0px;bottom:0px" height="100%" width="100%">\n\
<script>\n\
alert("");\n\
<\x2fscript>');
}